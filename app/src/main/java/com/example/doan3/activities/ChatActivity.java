...
import com.example.doan3.adapters.ChatAdapter;
import com.example.doan3.databinding.ActivityChatBinding;
...
public class ChatActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Assume you have a way to get the receiverUser object
        receiverUser = (User) getIntent().getSerializableExtra("user");

        AppCompatImageView videoCallButton = findViewById(R.id.infor);
        videoCallButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startOutgoingInvitationActivity();
            }
        });

    }

    private void startOutgoingInvitationActivity() {
        if (receiverUser != null) {
            sendCallNotification();
            Intent intent = new Intent(ChatActivity.this, OutgoingInvitationActivity.class);
    ...
    private void sendCallNotification() {
        if (!isReceiverAvailable) {
            try {
                ...
                data.put("type", "video");
                data.put("invitation", "incoming_call");
